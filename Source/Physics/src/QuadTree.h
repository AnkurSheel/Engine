...
namespace Physics
{
	...
	public:
		...
		void Collides(cRigidBody * const pBody, std::vector<cCollisionInfo> & collisions) { RCollides(pBody, m_pRoot, collisions); }
	...
	private:
		...
		void RCollides(cRigidBody * const pBody, const cQTNode * const pNode,
