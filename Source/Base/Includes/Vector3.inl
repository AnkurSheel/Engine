...
// *****************************************************************************
inline cVector3::cVector3(const float X, const float Y, const float Z)
: x(X)
, y(Y)
, z(Z)
{
...
// *****************************************************************************
inline cVector3 cVector3::Zero()
{
	return cVector3(0.0f, 0.0f, 0.0f);
}

// *****************************************************************************
inline cVector3 cVector3::Lerp(const cVector3 from, const cVector3 to, float alpha)
{
	return Interpolate<cVector3>(from, to, alpha);
}
...
// *****************************************************************************
inline cVector3 cVector3::Cross(const cVector3 & inVec) const
{
...
// *****************************************************************************
cVector3 operator*(const cVector3 & inVec1, const float fVal)
{
...
// *****************************************************************************
cVector3 operator*(const float fVal, const cVector3 & inVec1)
{
	cVector3 result(inVec1);
	result *= fVal;
	return result;
